        ...
        <div class="col-lg-4">
          ...
          <form method="POST" action="{{ route('register') }}" class="mt-3">
            ...
            <div class="form-group">
              ...
              <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" v-model="name"
            ...
            <div class="form-group">
              ...
              <input id="email" type="email" @change="checkEmail()" class="form-control @error('email') is-invalid @enderror" :class="{ 'is_invalid' : this.email_unavailable }" name="email" v-model="email" 
